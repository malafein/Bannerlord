...
and optionally auto_patterns (list of regex strings), auto_pass (bool),
auto_pass_all (bool — require ALL patterns to match, default is any).

Steps without auto_pass are MANUAL — they stay pending until marked on the web UI.
"""
...
STEPS = [
    ...
    # Manual: these are UI/visual checks with no log output
    # -----------------------------------------------------------------------
    {
    ...
    },
    {
        ...
        "expected": '"was not pleased by your letter" or outcome appears in log',
    ...
    },
    {
        ...
        "action": "Verify debug log shows all three rolls for a delivered missive",
        "expected": "receptionChance, improvementChance/backfireChance, and rolls all present",
    ...
    },
    {
        ...
        "action": "Verify debug log has all three MissiveThreat roll lines",
        "expected": "defianceChance/roll1a, amusementChance/roll1b, angerChance/roll2 all present",
    ...
    # Manual: UI menu checks with no definitive log output until sent
    # -----------------------------------------------------------------------
    {
    ...
    },
    {
        ...
        "action": "Select a third-party faction as the peace target and send",
    ...
    },
    {
        ...
        "action": "Select your own faction as the peace target and send",
    ...
    {
        # Can't auto-pass absence of a log line — mark manually after confirming no [CharmXP] appeared
